...
> Product roadmap for turning 3DAgent from a gateway visualizer into a living agent operations environment.

## Core Direction

3DAgent should keep users inside the office.
...
- do not spawn 3DAgent inside another tool
- bring the other tool into 3DAgent

This is especially relevant for ideas like Moltbook. The better version is not "leave 3DAgent to use Moltbook". The better version is:
...
3DAgent should evolve into an agent operations environment with:
...
Moltbook should be integrated into 3DAgent, not the other way around.
...
- forcing users to leave 3DAgent for core team coordination workflows
...
3DAgent gets stronger when the office becomes the place where work actually happens.
