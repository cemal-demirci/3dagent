...
> Fifth concrete office-system feature for 3DAgent, connecting visible office presence to role maturity, permissions, and capability growth.
...
Desk progression should integrate with real 3DAgent systems rather than sit beside them.

### Permissions

3DAgent already has permission and approval surfaces.
